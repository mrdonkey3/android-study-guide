package com.dk.android_art.customview.checkbox;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, UiCompatUtils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = UiCompatUtils.dp2px(getContext(), DEF_DRAW_SIZE);
